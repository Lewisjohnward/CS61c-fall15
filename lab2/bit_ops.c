...
unsigned get_bit(unsigned x,
    ...
    //1<<n is the position of the queried bit
    //(1<<b)&x and bitwise operator sets all bits other than queried bit to 0
    //>>n shifts bit back to position 0 and hence zero or one!
